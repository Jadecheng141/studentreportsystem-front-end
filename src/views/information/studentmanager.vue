...
import { searchCourses, updateFeeStatus } from '@/api/studentmanager'
  ...
  methods: {
    ...
    async edit(row) {
      try {
        ...
        this.temp = response.data.data; // Ensure this matches the actual structure of your API response
        this.dialogVisible = true;
        this.dialogType = '查看';
      } catch (error) {
